...
/**
 * An int/short map that is split into several smaller maps.  This is to avoid the problem where
...
public class SplitIntCharMap {
	...
	private final IntCharMap[] maps = new IntCharMap[NMAPS];

	public SplitIntCharMap() {
		for (int i = 0; i < NMAPS; i++) {
			maps[i] = new IntCharMap(INIT_CAP, LOAD);
	...
	/**
	 * The deleting iterator takes case of the case where you are transferring the entries from
