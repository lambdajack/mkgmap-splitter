 ...
 */
public class TestSparseClusteredBitSet{
         private final int NUM = 10000;
         private final long[] POS = {1, 63, 64, 65, 4711, 12345654321L};
	@Test
	public void testSparseClusteredBitSetSequential() {
         SparseClusteredBitSet sparseSet = new SparseClusteredBitSet();
	...
	@Test
  public void testSparseClusteredBitSetRandom() {
         SparseClusteredBitSet sparseSet = new SparseClusteredBitSet();
         for (long i: POS){
             sparseSet.set(i);
             Assert.assertEquals(sparseSet.get(i), true, "get("+i+")"); 
